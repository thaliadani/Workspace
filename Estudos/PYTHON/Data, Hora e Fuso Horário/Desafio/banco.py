...
CPF_INPUT_PROMPT = "Informe o CPF do cliente: "
...
class Historico:
    ...
    def transacoes_do_dia(self):
        ...
        return [transacao for transacao in self._transacoes if transacao["data"] == hoje]
    ...
    while True: 
        ...
        try:
            ...
            if escolha < 1 or escolha > len(cliente.contas):
                print("\n@@@ Número da conta inválida! Tente novamente. @@@")
            else:
